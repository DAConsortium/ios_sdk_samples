...
class ViewController: UIViewController, DACSDKMAAdsLoaderDelegate, DACSDKMAAdsManagerDelegate {
    ...
    // リクエスト先アドタグURI
    let adTagUri = "https://saxp.zedo.com/jsc/xp2/fns.vast?n=2696&c=26/11&d=17&s=2&v=vast2&pu=__page-url__&ru=__referrer__&pw=__player-width__&ph=__player-height__&z=__random-number__"
