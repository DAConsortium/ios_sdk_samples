...
- (void)prepareNativeAdLoader {
    self.loader = [[DACSDKNativeAdLoader alloc] initWithPlacementId: placementId];
...
/// 広告のロードが失敗した場合に呼ばれます。
- (void)dacSdkNativeAdLoader:(DACSDKNativeAdLoader * _Nonnull)loader didFailAdWithError:(NSError*)error{
    NSLog(@"%ld", (long)error);
}
